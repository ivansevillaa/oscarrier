...
Y si el usuario quiere testear algo asíncrono solo debería pasar como callback una función asíncrona, y usar await cuando sea necesario. Por ejemplo:
